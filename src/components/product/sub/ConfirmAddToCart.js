...
export default function ConfirmAddToCart(props) {
  const { open, setOpen, product, selectedOption, selectedColor, quantity } =
    props;
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        >
                          <RiInformationFill className="text-primary-600 mr-2" />
                        ...
                        <div className="mt-2 flex items-center ">
                          ...
                          <div className="flex flex-col items-start justify-center w-full min-h-[150px] ">
                            <div className="flex">
                              <b className="mr-2">Option:</b>
                              <p>
                                {
                            ...
                            <div className="flex">
                              <b className="mr-2">Số lượng:</b>
                              <p>{quantity}</p>
                            </div>
                            <div className="flex">
                              <b className="mr-2">Tổng cộng:</b>
                              <p>
                                {toVND(
                                  product?.productOptions[selectedOption]
                                    ?.price *
