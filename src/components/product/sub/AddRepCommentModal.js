...
import { replyComment } from '../../../actions/productActions'
import { toastWarn } from '../../../utils/ultils'

export default function AddRepCommentModal(props) {
  ...
  const repHandler = () => {
    if (cmt === '') {
      toastWarn('Vui lòng nhập nội dung hỏi/đáp')
      return
    } else {
      setOpen(false)
      const dataForm = {
      ...
      dispatch(replyComment(dataForm))
      setCmt('')
    }
  }
  return (
                ...
                <div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
                  <div className='sm:flex sm:items-start'>
                    ...
                    <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                      ...
                      >
                        Trả lời - Bình Luận: {product?.name}
                      </Dialog.Title>
                      <div className='mt-2 flex items-center '>
                        ...
                        <div className='flex flex-col items-start w-full min-h-[150px] '>
                          ...
                          <textarea
                            type='name'
                            name='comment'
                            className=' break-all  mt-1 block w-full min-h-[80px] p-2 text-black placeholder-gray-500 transition-all 
